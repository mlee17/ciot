function [output_cos, output_sin, output_amp, x_est, y_est, V_indiv, std_indiv, output_side_cos, output_side_sin] = getPhases_trial(file_directory, target_frequencies)
