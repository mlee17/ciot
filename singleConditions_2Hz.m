function mean_single = singleConditions_2Hz(file_dir,subj_label)%(cond, conditions_to_visualize, groups_to_visualize, target_freq, file_name)
cond = 2;
...
%             end
            ...
            for i = 1:length(thisSingleConds)
                ...
                amp_single(i) = a(target_freq*2 +1, thisSingleConds(i));
            end
...
%             amplitude = axx_get_frequency(a(:,conditions_to_visualize(jj)), target_freq);
        ...
        for cc = 1:length(single_conditions);
            thisSingleCondition = single_conditions(cc);
            amplitude = axx_get_frequency(a(:,thisSingleCondition), target_freq);
            single_amplitude(cc) = amplitude;
            average_amplitude = axx_get_avg_frequency(a(:, thisSingleCondition), target_freq);
            average_single_amplitude(cc) = average_amplitude;
