...
for s = 1:length(subjectList)
    ...
    [output_cos{s}, output_sin{s}, output_amp{s}, x_est{s}, y_est{s}, V_indiv{s}, std_indiv{s} output_side_cos{s}, output_side_sin{s}] =...
        getPhases_trial(thisDir, target_frequencies);
